...
### Requirement: Express API server endpoints

> The endpoint definitions in this requirement (GET /api/blocks, GET /api/transaction-pool-map, POST /api/transact, GET /api/mine-transactions, GET /api/wallet-info) are owned exclusively by api-endpoints/spec.md and have been removed here to eliminate cross-spec duplication. This requirement is retained only as an integration pointer.
